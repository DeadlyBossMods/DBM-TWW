...
mod:AddAuraSoundOption(1233411, true, 1233416, 3, 1, "lineyou", 17)--Crystalline Shockwave pre-debuff
mod:AddAuraSoundOption(1247424, true, 1247424, 1, 1, "runout", 2)--Null Consumption
mod:AddAuraSoundOption(1227373, true, 1227373, 1, 1, "targetyou", 2)--Shattershell

...
mod:AddAuraSoundOption(466155, true, 466155, 1, 1, "bombyou", 12)--Sapper's Satchel (sub mechanic to BBBBombs)
...
mod:AddAuraSoundOption(466344, true, 466341, 2, 1, "gather", 2)--Fused Canister
----Darkfuse Cronies
...
mod:AddAuraSoundOption(1219279, true, 1219279, 2, 1, "lineyou", 17)--Gallybux Pest Eliminator (Mythic only)
...
mod:AddAuraSoundOption({1226489,1214767,1214750,1214763,1214758,1214765,1214761,1214766,1214749,1214762,1214759,1214764,1214760}, true, 1226489, 2, 1, "lineyou", 17)--Overloaded Rockets (sub mechanic to BBBBlast)
--Mythic

...
local specWarnAmplification							= mod:NewSpecialWarningDodgeCount(473748, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnEchoingChant							= mod:NewSpecialWarningDodgeCount(466866, nil, nil, nil, 2, 2, nil, nil, "watchwave")
local specWarnSoundCannonSoakBadQA					= mod:NewSpecialWarningYou(467606, nil, nil, nil, 1, 2, 4, nil, "targetyou")
local yellSoundCannonSoak							= mod:NewYell(467606, nil, nil, nil, "YELL")
local specWarnSoundCannonSoak						= mod:NewSpecialWarningSoakCount(467606, nil, nil, nil, 2, 2, 4, nil, "helpsoak")
local specWarnEntranced								= mod:NewSpecialWarningSwitchCustom(1214598, "Dps", nil, nil, 1, 2, 4, nil, "findmc")--Could be spammy?
local specWarnFaultyZap								= mod:NewSpecialWarningMoveAway(466979, nil, nil, nil, 1, 2, nil, nil, "scatter")
local yellFaultyZap									= mod:NewYell(466979)
local specWarnSparkBlastIngition					= mod:NewSpecialWarningSwitchCount(472306, nil, nil, nil, 1, 2, nil, nil, "killmob")
local specWarnTinnitusTaunt							= mod:NewSpecialWarningTaunt(464518, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specwarnResonance								= mod:NewSpecialWarningMove(466128, nil, nil, nil, 1, 2, nil, nil, "moveboss")
...
local specWarnHypeHustle							= mod:NewSpecialWarningCount(464584, nil, nil, nil, 2, 2, nil, nil, "phasechange")
local specWarnHypeFever								= mod:NewSpecialWarningCount(473655, nil, nil, nil, 3, 2, nil, nil, "stilldanger")
local specWarnBlaringDrop							= mod:NewSpecialWarningDodgeCount(473260, nil, nil, nil, 2, 15, nil, nil, "getknockedup")

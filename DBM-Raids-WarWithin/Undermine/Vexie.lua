...
mod:AddAuraSoundOption(459669, true, 459678, 1, 1, "poolyou", 18)--Spew Oil
mod:AddAuraSoundOption(468486, true, 468207, 2, 1, "flameyou", 12)--Incendiary Fire--For some reason, blizzard gave a spell that has a 6 second pre debuff, an additional 4 second pre pre debuff private aura
----Geargrinder Biker

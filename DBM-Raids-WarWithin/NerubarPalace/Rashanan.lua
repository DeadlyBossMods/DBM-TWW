...
mod:AddAuraSoundOption({439790,434406}, true, 439789, 1, 1, "targetyou", 2)--Rolling Acid target
mod:AddAuraSoundOption({455284,439815}, true, 455373, 1, 1, "mobout", 2)--Infested Spawn target
mod:AddAuraSoundOption({439783,434090}, true, 439784, 1, 1, "runout", 2)--Spineret's Strands target
